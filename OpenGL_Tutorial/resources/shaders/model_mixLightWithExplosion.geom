...
void main(){
	...
	// newPosition = projectionAndView * explode(gl_in[0].gl_Position, normal);
	...
	gTBN = vTBN[0];
	gFragPosition = vFragPosition[0];
	// gFragPosition = vec3(gl_in[0].gl_Position);
	EmitVertex();
	...
	// gFragPosition = vec3(gl_in[1].gl_Position);
	EmitVertex();
	...
	// gFragPosition = vec3(gl_in[2].gl_Position);
	EmitVertex();
