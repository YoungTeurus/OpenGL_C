...
{
public:
	Model(const string& path, vector<Texture> &loadedTextures, bool isUV_flipped = false)
	{
		textures_loaded = &loadedTextures;
		loadModel(path, isUV_flipped);
	}
	
    Model(const string& path, bool isUV_flipped = false)
    {
		textures_loaded = new vector<Texture>();
        loadModel(path, isUV_flipped);
    }
...
private:
    ...
    void loadModel(const string& path, const bool isUV_flipped);
...
inline void Model::loadModel(const string& path, const bool isUV_flipped)
{
